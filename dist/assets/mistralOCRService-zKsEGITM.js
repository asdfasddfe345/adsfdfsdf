...
`).filter(t=>t.trim().length>0),n=[];return r.forEach((t,o)=>{n.push({x:50,y:50+o*25,width:Math.min(500,t.length*8),height:20})}),n}}const y=new u;export{u as MistralOCRService,y as mistralOCRService};
